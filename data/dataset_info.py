...
DATASET_INFO = {
    'unified_edit':{
        'terra': {
            'data_dir': 'Path_to_TerraBagel/terra_data/editing_parquets/parquet',
            'num_files': 11,
            'num_total_samples': 21000,
            "parquet_info_path": 'Path_to_TerraBagel/terra_data/editing_parquets/parquet/parquet_info.json', # information of the parquet files
		},
    },
    # 'vlm_sft': {
    #     # 暂时不用 VLM
